...
from kvadstat.mapping import _parse_rate
from kvadstat.merge import merge_databases
from kvadstat.sources.base import safe_next_url
from kvadstat.sources.brusnika import _to_norm as _brusnika_to_norm
from kvadstat.store import _assign_nearest_metro, apply_schema, upsert
...
def test_brusnika_region_prefixes_collide_only_after_split():
    ...
    """
    from kvadstat.sources.base import to_global_id
