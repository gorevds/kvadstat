...
# Доля отбракованных квартир, выше которой день застройщика — 'partial':
# массовая отбраковка означает смену формата/единиц у API (например цены в
# копейках), и velocity не должна судить об исчезновениях по такому дню.
