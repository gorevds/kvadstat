...
с глобально-уникальными id (см. kvadstat.developers).
"""
...
from kvadstat import PikParserError
from kvadstat.developers import ID_NAMESPACE, namespaced_id, stable_int_id
from kvadstat.geo import CITY_CENTERS, city_from_address, haversine_km
from kvadstat.quality import GEO_MAX_KM, DataQualityStats, geo_ok, price_ok

log = logging.getLogger("kvadstat.sources")
...
def build_rows(
    ...
    *,
    ...
    Data-quality gate (см. kvadstat.quality): ЖК с координатами дальше GEO_MAX_KM
