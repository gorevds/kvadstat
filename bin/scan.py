"""DEPRECATED shim: оставлен для обратной совместимости с kvadstat-scan.service'ом
...
существующий kvadstat-scan.service до его обновления через install.sh.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    log = logging.getLogger("kvadstat.scan")
    log.warning(
